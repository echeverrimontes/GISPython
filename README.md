# GISPython
# Data Sources:
We searched the web for open-data for our purposes and we found:

-http://iridl.ldeo.columbia.edu/

-https://climatedataguide.ucar.edu/data-type/gridded-obs

-https://donneespubliques.meteofrance.fr/

But the want the we chose was:

-http://nomads.ncep.noaa.gov/

We chose the NCEP because they update most of the data sets regularly.

I made a script that gets all the data from a specific data set:
